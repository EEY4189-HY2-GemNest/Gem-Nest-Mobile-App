...
export default function VerificationDialog({ type, userName, onConfirm, onCancel, isLoading }) {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
            <div className={`bg-gradient-to-br ${bgColor} border ${borderColor} rounded-2xl shadow-2xl w-full max-w-md mx-4 p-0 overflow-hidden`}>
                {/* Header */}
                <div className={`bg-gradient-to-r ${isVerify ? 'from-green-900/30 to-green-900/10' : 'from-red-900/30 to-red-900/10'} border-b ${borderColor} px-6 py-4 flex items-center justify-between`}>
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-xl font-bold text-white">
                            {isVerify ? 'Verify Seller' : 'Reject Seller'}
                        </h2>
                    </div>
                    <button
                        onClick={onCancel}
                ...
                <div className="px-6 py-6 space-y-4">
                    <p className="text-gray-300">
                        {isVerify
                            ? `Are you sure you want to verify ${userName} as a seller?`
                            : `You are about to reject ${userName}'s seller verification.`
                        }
                    </p>
                    ...
                    {!isVerify && (
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                placeholder="Explain why you're rejecting this seller verification..."
                    ...
                    {isVerify && (
                        <div className="bg-green-900/20 border border-green-700/30 rounded-lg p-4">
                            <p className="text-green-300 text-sm flex items-center gap-2">
                                ...
                                This seller will be marked as verified immediately
                            </p>
                        </div>
                    )}
                ...
                {/* Footer */}
                <div className={`bg-gradient-to-r ${isVerify ? 'from-gray-900/50 to-gray-800/50' : 'from-gray-900/50 to-gray-800/50'} border-t ${borderColor} px-6 py-4 flex items-center justify-end gap-3`}>
                    <button
                        onClick={onCancel}
                        disabled={isLoading}
