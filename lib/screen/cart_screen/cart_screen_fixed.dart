            ...
            itemBuilder: (context) => [
              PopupMenuItem(
                value: cartProvider.selectedItems.length == cartProvider.items.length
                    ...
                    : 'selectAll',
                child: Text(
                  cartProvider.selectedItems.length == cartProvider.items.length
                      ? 'Deselect All'
                      : 'Select All',
                ),
              ),
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Icon(
                                ...
                                size: 18,
                                color: item.isWishlisted ? Colors.pink : Colors.grey[600],
                              ),
                            ),
                          ),
                          const SizedBox(width: 8),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (cartProvider.appliedCoupon.isNotEmpty) ...[
            Container(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildPriceRow(
            'Subtotal (${cartProvider.selectedItems.length} items)',
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${cartProvider.selectedItems.length} items selected',
                      style: TextStyle(
                        fontSize: 12,
                        color: Colors.grey[600],
                      ),
